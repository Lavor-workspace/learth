(function($) {
  ...
  $(function() {
    ...
    if ($('#owl-carousel-basic2').length) {
        $('#owl-carousel-basic2').owlCarousel({
          loop: true,
          margin: 10,
          dots: false,
          nav: true,
      ...
      if ($('#owl-carousel-basic3').length) {
        $('#owl-carousel-basic3').owlCarousel({
          loop: true,
          margin: 10,
          dots: false,
          nav: true,
      ...
      if ($('#owl-carousel-basic4').length) {
        $('#owl-carousel-basic4').owlCarousel({
          loop: true,
          margin: 10,
          dots: false,
          nav: true,
      ...
      if ($('#owl-carousel-basic5').length) {
        $('#owl-carousel-basic5').owlCarousel({
          loop: true,
          margin: 10,
          dots: false,
          nav: true,
